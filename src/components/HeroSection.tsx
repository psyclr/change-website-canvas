...
const HeroSection = () => {
  return (
    <section className="py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 sm:px-10 text-center md:text-left">
        <div className="max-w-3xl mx-auto md:mx-0">
          <h1 className="text-4xl md:text-5xl lg:text-6xl leading-tight tracking-tight mb-8 animate-fade-in font-normal">
            You just need a <span className="highlight">normal website</span>. We'll make it.
          </h1>
          <p className="text-lg md:text-xl text-foreground/80 mb-10 max-w-2xl mx-auto md:mx-0 animate-fade-in leading-relaxed" style={{animationDelay: "0.2s"}}>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center md:justify-start animate-fade-in" style={{animationDelay: "0.4s"}}>
            <Button asChild size="lg" className="rounded-full shadow-sm hover:shadow-md group bg-primary/90 hover:bg-primary">

                ...
                <div>
                  ...
                  <ul className="space-y-1">
                    <li className="flex items-start">
                      ...
                      <a href={`mailto:${contactInfo.email}`} className="text-foreground/70 hover:text-foreground text-sm leading-tight">
                        {contactInfo.email}
                      </a>
                    </li>
                    <li className="flex items-start">
                      <Phone className="h-3 w-3 text-primary mr-2 mt-1" />
                      <span className="text-foreground/70 text-sm leading-tight">{contactInfo.phone}</span>
                    </li>
                    <li className="flex items-start">
                ...
                <div>
                  ...
                  <ul className="space-y-1">
                    <li className="flex items-start">
                      ...
                      <a href="#services" className="text-foreground/70 hover:text-foreground text-sm leading-tight">{t('footer.services.new_website')}</a>
                    </li>
                    <li className="flex items-start">
                      <Wrench className="h-3 w-3 text-primary mr-2 mt-1" />
                      <a href="#services" className="text-foreground/70 hover:text-foreground text-sm leading-tight">{t('footer.services.fix_website')}</a>
                    </li>
                    <li className="flex items-start">
                      <HeadphonesIcon className="h-3 w-3 text-primary mr-2 mt-1" />
                      <a href="#services" className="text-foreground/70 hover:text-foreground text-sm leading-tight">{t('footer.services.support')}</a>
                    </li>
                  </ul>
                </div>
